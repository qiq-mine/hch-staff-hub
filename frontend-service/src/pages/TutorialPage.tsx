    ...
    <main className="tutorial-doc-page">
      <section className="tutorial-doc-hero" id="intro">
        <div className="tutorial-doc-hero-copy">
          <span className="ui-typography tutorial-doc-eyebrow">TeamerHub Docs</span>
          <h1 className="ui-typography">企业数字员工与团队协同运行时，从配置到持续运营</h1>
          <p className="ui-typography">
            TeamerHub 把模型、数字员工、团队协同、知识库、技能、SOP、工具、记忆、定时任务和 Trace 放到一条链路里，
            让企业拥有可配置、可验证、可复盘的业务流程与多Agent团队对话系统。
          </p>
        ...
        <div className="tutorial-doc-hero-map" aria-label="TeamerHub runtime map">
      ...
      <div className="tutorial-doc-shell">
        <aside className="tutorial-doc-nav" aria-label="TeamerHub 单页文档目录">
      ...
      <section className="tutorial-doc-section tutorial-doc-intro-panel">
        <div>
          ...
          <p className="ui-typography">
            TeamerHub 的核心不是“能聊天”，而是让真实岗位与协作团队拥有独立的配置、资源、执行规则和运营记录。
      ...
      <section className="tutorial-doc-section" id="core-features">
        <SectionHeading
          ...
          body="TeamerHub 把能力沉淀为多Agent协同、岗位边界、知识治理、SOP状态机流程执行、沙箱工具调用和运营复盘。"
        />
      ...
      <section className="tutorial-doc-section tutorial-doc-runtime" id="runtime">
        <SectionHeading
          ...
          title="一条业务请求如何被推进"
          body="TeamerHub 的对话不是单轮问答。它会在路由、团队分工、知识、技能、SOP、工具和回复生成之间形成可追踪执行链路。"
        />
